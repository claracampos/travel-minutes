    ...
    <div className="d-flex justify-content-center bg-light">
      <div className="main-container shadow-lg">
        ...
        <div className="p-4 text-justify">
          ...
          <p className="lead mt-4 mb-2 font-italic">After logging in:</p>
          ...
          <p>
            On your <i>Travel Log</i> page, find the entry you would like to
            alter and click the side button to expand it. Click “Edit” at the
            bottom of the entry to alter the details.
          </p>
          <p className="font-weight-bold mb-0">How do I delete an entry?</p>
          <p>
            Follow the steps above (<i>"How do I edit an entry?"</i>). At the
            bottom of the Edit page, you will find a “Delete entry” option.
            Please note that once an entry has been deleted, it cannot be
            restored -- it is gone for good.
          </p>
          <p className="font-weight-bold mb-0">
